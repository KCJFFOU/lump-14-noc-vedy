...
.lump-scale {border:1px solid rgba(128,149,167,.3);border-radius:12px;padding:1.1rem 1.25rem 1.2rem;margin:.65rem 0 1.15rem;background:rgba(128,149,167,.035)}
.lump-scale-top {display:flex;justify-content:space-between;align-items:end;gap:1rem;flex-wrap:wrap}
.lump-scale-label {font:700 .68rem ui-monospace,Consolas,monospace;letter-spacing:.11em;color:#8294a4}
.lump-scale-value {font:750 1.75rem ui-monospace,Consolas,monospace;letter-spacing:-.055em;font-variant-numeric:tabular-nums;margin-top:.2rem}
.lump-scale-threshold {font:600 .78rem ui-monospace,Consolas,monospace;color:#8294a4}
.lump-scale-track {position:relative;height:13px;border-radius:7px;background:linear-gradient(to right,#4a9a76 0%,#4a9a76 var(--p2),#c66a61 var(--p2),#c66a61 100%);margin:1.55rem 0 1.1rem}
.lump-scale-track .threshold {position:absolute;left:var(--p2);height:29px;top:-8px;width:2px;background:#24384b;transform:translateX(-50%)}
.lump-scale-track .needle {position:absolute;left:var(--score);top:-7px;width:14px;height:14px;background:#f9fbfc;border:3px solid #172536;border-radius:50%;transform:translateX(-50%);box-shadow:0 1px 4px #10192355}
.lump-scale-ticks,.lump-scale-zones {display:flex;justify-content:space-between;gap:8px;font:600 .72rem ui-monospace,Consolas,monospace;color:#8294a4}
.lump-scale-zones {margin-top:.65rem;font-size:.67rem;letter-spacing:.06em}.lump-scale-zones span:first-child{color:#248554}.lump-scale-zones span:last-child{color:#b65b55}
.lump-scale-off {height:13px;border-radius:7px;background:repeating-linear-gradient(90deg,#aab5be 0,#aab5be 12px,#d9dfe4 12px,#d9dfe4 18px);margin:1.5rem 0 .9rem;opacity:.65}
